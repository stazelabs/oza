...
var (
	...
	ErrInvalidSectionTableOffset = errors.New("oza: section_table_offset must equal 128 for v1")
	...
	ErrUnknownCriticalSection    = errors.New("oza: unknown section with SECTION_CRITICAL flag set")
)

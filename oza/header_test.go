...
// TestParseHeader_RejectsVersionZero pins the SPEC.md §3.2 contract that
// version 1 is the only currently-defined major. Version 0 is not a valid
// in-flight pre-v1 marker; readers MUST reject it just like a future major.
...
// for the flags field: SPEC.md §3.2 says "readers MUST ignore unknown bits".
// We assert that a header with bit 7 set (currently undefined) parses
// successfully and that the known accessors still report the right values.
